    ...
    namespace gui
    {
        namespace app
        {
            ...
            const api_doc API_KEYWORDS{
                ...
                {"clock","app:clock() -- makes a new vector clock"},
                ...
                {"get_clock", "dict:get_clock -- returns vclock with the key from the dictionary"},
                ...
                {"set_clock", "dict:set_clock(key, vclock) -- stores vclock data with the key"},
